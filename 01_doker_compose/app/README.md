...
1) Сформировать виртуальное Python-окружение
2) Установить зависимости задания `pip install -r requirements`
3) Установить pre-commit hook `pre-commit install` (для разработки)
